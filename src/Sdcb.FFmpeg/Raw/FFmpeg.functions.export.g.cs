...
namespace Sdcb.FFmpeg.Raw
{
    public unsafe static partial class ffmpeg
    {
        ...
        public static extern int av_bitstream_filter_filter(AVBitStreamFilterContext* bsfc, AVCodecContext* avctx, [MarshalAs(UnmanagedType.LPUTF8Str)] string args, byte** poutbuf, int* poutbuf_size, byte* buf, int buf_size, int keyframe);
        
        [Obsolete("the old bitstream filtering API (using AVBitStreamFilterContext) is deprecated. Use av_bsf_send_packet() and av_bsf_receive_packet() from the new bitstream filtering API (using AVBSFContext).")]
        [DllImport("avcodec-58", EntryPoint = "av_bitstream_filter_filter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_bitstream_filter_filter(AVBitStreamFilterContext* bsfc, AVCodecContext* avctx, [MarshalAs(UnmanagedType.LPUTF8Str)] string args, ref byte* poutbuf, int* poutbuf_size, byte* buf, int buf_size, int keyframe);
        ...
        public static extern AVBitStreamFilterContext* av_bitstream_filter_init([MarshalAs(UnmanagedType.LPUTF8Str)] string name);
        ...
        public static extern AVBitStreamFilter* av_bsf_get_by_name([MarshalAs(UnmanagedType.LPUTF8Str)] string name);
        ...
        public static extern int av_bsf_list_append2(AVBSFList* lst, [MarshalAs(UnmanagedType.LPUTF8Str)] string bsf_name, AVDictionary** options);
        ...
        /// <param name="options">Options for the bitstream filter, can be set to NULL</param>
        [DllImport("avcodec-58", EntryPoint = "av_bsf_list_append2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_bsf_list_append2(AVBSFList* lst, [MarshalAs(UnmanagedType.LPUTF8Str)] string bsf_name, ref AVDictionary* options);
        ...
        public static extern int av_bsf_list_parse_str([MarshalAs(UnmanagedType.LPUTF8Str)] string str, AVBSFContext** bsf);
        
        /// <summary>Parse string describing list of bitstream filters and create single AVBSFContext describing the whole chain of bitstream filters. Resulting AVBSFContext can be treated as any other AVBSFContext freshly allocated by av_bsf_alloc().</summary>
        /// <param name="str">String describing chain of bitstream filters in format `bsf1[=opt1=val1:opt2=val2][,bsf2]`</param>
        /// <param name="bsf">Pointer to be set to newly created structure representing the chain of bitstream filters</param>
        [DllImport("avcodec-58", EntryPoint = "av_bsf_list_parse_str", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int av_bsf_list_parse_str([MarshalAs(UnmanagedType.LPUTF8Str)] string str, ref AVBSFContext* bsf);
        ...
        public static extern int avpriv_io_delete([MarshalAs(UnmanagedType.LPUTF8Str)] string url);
        ...
        public static extern int avpriv_io_move([MarshalAs(UnmanagedType.LPUTF8Str)] string url_src, [MarshalAs(UnmanagedType.LPUTF8Str)] string url_dst);
        ...
        public static extern int av_parse_cpu_flags([MarshalAs(UnmanagedType.LPUTF8Str)] string s);
